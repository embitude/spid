...
static int my_mcspi_probe(struct platform_device *pdev)
{
	...
	// TODO 3.4 Allocate the memory for omap2_mcspi and assign it to mcspi
	
    platform_set_drvdata(pdev, mcspi);

	// TODO 3.5 Get the base address from platform device
    if (r == NULL) {
        return -ENODEV;
    }
	/*
    ...
    */
	...
	// TODO 3.6: Get padconf base address from the platform device & use ioremap to get the corresponding virtual address
...
//TODO 4.1 Populate the id table with compatible property as per dtb
...
static struct platform_driver my_mcspi_driver = {
	    //TODO 4.2 Initialize .of_match_table
        // Hint: Refer gpio_dtb.c
};
